                            ...
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="template/pages/widgets.html" class="menu-item">Basic</a>
                                        <a href="template/pages/widget-statistic.html" class="menu-item">Statistic</a>
                                        <a href="template/pages/widget-data.html" class="menu-item">Data</a>
                                        <a href="template/pages/widget-chart.html" class="menu-item">Chart Widget</a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="template/pages/ui/alerts.html" class="menu-item">Alerts</a>
                                        <a href="template/pages/ui/badges.html" class="menu-item">Badges</a>
                                        <a href="template/pages/ui/buttons.html" class="menu-item">Buttons</a>
                                        <a href="template/pages/ui/navigation.html" class="menu-item">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="template/pages/ui/modals.html" class="menu-item">Modals</a>
                                        <a href="template/pages/ui/notifications.html" class="menu-item">Notifications</a>
                                        <a href="template/pages/ui/carousel.html" class="menu-item">Slider</a>
                                        <a href="template/pages/ui/range-slider.html" class="menu-item">Range Slider</a>
                                        <a href="template/pages/ui/rating.html" class="menu-item">Rating</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-package"></i><span>Extra</span></a>
                                    <div class="submenu-content">
                                        <a href="template/pages/ui/session-timeout.html" class="menu-item">Session Timeout</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="template/pages/ui/icons.html"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                <div class="nav-lavel">Forms</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <div class="submenu-content">
                                        <a href="template/pages/form-components.html" class="menu-item">Components</a>
                                        <a href="template/pages/form-addon.html" class="menu-item">Add-On</a>
                                        <a href="template/pages/form-advance.html" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="template/pages/form-picker.html"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="template/pages/table-bootstrap.html"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="template/pages/table-datatable.html"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="template/pages/charts-chartist.html" class="menu-item active">Chartist</a>
                                        <a href="template/pages/charts-flot.html" class="menu-item">Flot</a>
                                        <a href="template/pages/charts-knob.html" class="menu-item">Knob</a>
                                        <a href="template/pages/charts-amcharts.html" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item">
                                    <a href="template/pages/calendar.html"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="template/pages/taskboard.html"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="template/pages/login.html" class="menu-item">Login</a>
                                        <a href="template/pages/register.html" class="menu-item">Register</a>
                                        <a href="template/pages/forgot-password.html" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-file-text"></i><span>Other</span></a>
                                    <div class="submenu-content">
                                        <a href="template/pages/profile.html" class="menu-item">Profile</a>
                                        <a href="template/pages/invoice.html" class="menu-item">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="template/pages/layouts.html"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
